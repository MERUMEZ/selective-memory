...
**Дата:** 2026-08-01 · **Коммит:** `90829a8` · **Тестов:** 284 · **Строк Python:** 18 424
...
| режим | узлов | R@1 | R@5 | R@10 |
|---|---|---|---|---|
| рабочий | 1 602 | 13.3% | **18.3%** | 18.3% |
| архив | 14 623 | 76.7% | **91.7%** | 96.7% |

**Извлечение конкурентоспособно (91.7%), губит политика записи.** Гейт
пишет каждую девятую пару реплик. На вопросах об обновлении знаний
архив даёт 100%, рабочий режим 0% — вытеснение версий работает, до него
не доходит.

Попутно найдено: `MEMORY_SEARCH_THRESHOLD=0.3` откалиброван под русский
бот и на английском молча возвращал ноль результатов в 11 случаях из 25.
