...
(`--balanced`) разрыв **+53 п.п.**, то есть работает подкрепление, а не
...
- сжатие: 14–27 узлов против 30–41 при равном объёме текста
...
Разница с несмещённым отбором — ровно ноль. Одиночные прогоны давали то
90% против 94%, то 92% против 90%; на пяти сидах не то и не другое.
