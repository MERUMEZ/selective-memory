# Коммерческая лицензия decaymem — ЧЕРНОВИК
...
**Предмет:** программная библиотека `decaymem` (далее — Программа),
...
4. Использовать наименование `decaymem` и имя Лицензиара для
