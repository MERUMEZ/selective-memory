...
снято как неизмеренное. Стенд писал ВСЕ узлы с одним весом 0.7 и никогда
их не подкреплял. При равных силах слагаемое одинаково у всех кандидатов
и лишь сдвигает счёт целиком — переставить оно ничего не может.
Проверка это и показала: ранжирование по силе, включённое и выключенное,
давало ПОБАЙТОВО одинаковые числа. Это пятый случай той же ошибки,
описанной в 2.13, и поймала его та же привычка — смотреть, сработал ли
механизм, прежде чем верить в «разницы нет».
