...
class MemorySettings:
    ...
    # Записей на 41% меньше ценой 0.8 пункта. Для избирательной памяти это
    # выгодно, но это РАЗМЕН, а не чистый выигрыш, — поэтому решает
    # приложение, а не мы за него.
    intrinsic_emotion: bool = False
