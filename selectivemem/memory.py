...
организм помнит 100% отмеченного пользователем как важное против 50%
обычного — разрыв +50 п.п. При этом на РАВНОМЕРНЫХ вопросах он не лучше
случайной выборки (87.2% против 88.8%), и это тоже измерено. Инструмент
