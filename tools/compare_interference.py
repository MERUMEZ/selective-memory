...
ТРЕТИЙ ВОПРОС, И ОН ОКАЗАЛСЯ ГЛАВНЫМ: не портит ли память сама себя при
записи. Портила. Механизм вытеснения устаревшего принимал почти-двойника
за поправку и штрафовал оригинал — 6078 срабатываний на 200 записей, и
сила у шести настоящих фактов падала до 0.0000 при 0.0292 у их копий.
Разделение образов на входе (pattern_separation_limit) это сняло:

    R@1 при 200 отвлекающих   53.3% -> 73.3%
    R@5 при 200 отвлекающих   83.3% -> 73.3%

Цена в полноте настоящая и названа в разделе 2.18 аудита.
