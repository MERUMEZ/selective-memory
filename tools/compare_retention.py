...
РЕЗУЛЬТАТ на пяти сидах (1, 7, 13, 42, 99), молчание 14 суток:
    ...
    последние (окно)         21          63%      70%      -7%
    случайные (контроль)     22          57%      67%     -10%
    организм                 14          97%      47%     +50%

С КОНТРОЛЕМ НА ОБЪЁМ (--balanced, обе группы дают по два сообщения):
    последние (окно)         21          50%      37%     +13%
    случайные (контроль)     23          20%      40%     -20%
    организм                 18          97%      43%     +53%
...
+50..+53 п.п. и ПЕРЕЖИВАЕТ контроль на объём,
